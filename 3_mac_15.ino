...
*/
  ...
  float drive = 1.1*error*Kp*error*error+integral*Ki+derivative*Kd;
...
boolean isOnMid()
{
 if((sensorReading[0]==1)&&(sensorReading[7]==1)&&(sensorReading[2]==0||sensorReading[3]==0||sensorReading[4]==0||sensorReading[5]==0))
 {
   Serial.print("\n\nmid is on\n\n");
 return true;
 }
...
//////////////////////////////////////////////////////////////////////////rotateUntilLineFound/////////////////////
boolean rotateUntilLineFound()
{
...
void SetTurningDirection()
{
  ...
  if((millis()-loop_timer)>3000)
  {
    Serial.print("ccccccccccc");
   toRotate='c';
  loop_timer=millis(); 
  }
 if(sensorReading[0]==0&& sensorReading[7]==1)
 toRotate='l';
 else if(sensorReading[0]==1&&sensorReading[7]==0)
 toRotate='r';
 for(int i=0;i<8;i++)
 {
  Serial.print(sensorReading[i]); 
